# Hover Card Component Contract

## Purpose

A preview card that opens when the pointer rests on a link or name, and on keyboard focus

## Source

`packages/components/hover-card/hover-card.tsx`
