...
A right-click menu built for what was clicked, with shortcuts, typeahead, long-press on touch and Shift+F10

## Source

`packages/components/context-menu/context-menu.tsx`
