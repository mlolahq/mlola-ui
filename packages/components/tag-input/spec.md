# Tag Input Component Contract

## Purpose

Many short values in one field: add with Enter or a comma, paste lists, remove with Backspace, with suggestions and validation

## Source

`packages/components/tag-input/tag-input.tsx`
