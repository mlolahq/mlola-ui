...
A date field that opens a calendar, for one date or a range with presets, shown in the reader's format and stored as ISO

## Source

`packages/components/date-picker/date-picker.tsx`
