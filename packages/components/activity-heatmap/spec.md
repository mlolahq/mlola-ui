# Activity Heatmap Component Contract

## Purpose

Activity by day in GitHub's calendar grid, with quantile shading, a keyboard grid and hover detail

## Source

`packages/components/activity-heatmap/activity-heatmap.tsx`
