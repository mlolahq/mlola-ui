# Command Menu Component Contract

## Purpose

The ⌘K palette: ranked commands with shortcuts, keyboard navigation and matched letters bolded

## Source

`packages/components/command-menu/command-menu.tsx`
