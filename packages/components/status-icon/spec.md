# Status Icon Component Contract

## Purpose

A work item status as one glyph: backlog, todo, in progress, in review, done and canceled, readable without colour

## Source

`packages/components/status-icon/status-icon.tsx`
