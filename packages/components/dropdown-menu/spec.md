# Dropdown Menu Component Contract

## Purpose

A keyboard-navigable dropdown menu with icons, shortcuts, and danger items

## Source

`packages/components/dropdown-menu/dropdown-menu.tsx`
